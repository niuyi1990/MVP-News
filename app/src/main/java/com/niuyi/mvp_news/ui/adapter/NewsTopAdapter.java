 ...
 */
public class NewsTopAdapter extends BaseQuickAdapter<TopNewsBean.ResultBean.DataBean, BaseViewHolder> {

    public NewsTopAdapter(List<TopNewsBean.ResultBean.DataBean> data) {
        super(R.layout.item_top, data);
    }

    @Override
    protected void convert(BaseViewHolder baseViewHolder, TopNewsBean.ResultBean.DataBean dataBean) {
