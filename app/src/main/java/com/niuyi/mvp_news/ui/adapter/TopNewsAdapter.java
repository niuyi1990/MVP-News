...
public class TopNewsAdapter extends RecyclerView.Adapter<TopNewsAdapter.ViewHolder> {
    ...
    private ArrayList<TopNewsBean.ResultBean.DataBean> mList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TopNewsBean.ResultBean.DataBean dataBean = mList.get(position);
    ...
    public void setData(ArrayList<TopNewsBean.ResultBean.DataBean> list) {
        mList = list;
