 ...
 */
public class TentertainmentAdapter extends RecyclerView.Adapter<TentertainmentAdapter.ViewHolder> {

    private Context mContext;
    private ArrayList<TentertainmentNewsBean.ResultBean.DataBean> mList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TentertainmentNewsBean.ResultBean.DataBean dataBean = mList.get(position);
    ...
    public void setData(ArrayList<TentertainmentNewsBean.ResultBean.DataBean> list) {
        mList = list;
