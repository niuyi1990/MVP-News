...
public class DomesticAdapter extends RecyclerView.Adapter<DomesticAdapter.ViewHolder> {
    ...
    ArrayList<DomesticNewsBean.ResultBean.DataBean> mList;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        DomesticNewsBean.ResultBean.DataBean dataBean = mList.get(position);
    ...
    public void setData(ArrayList<DomesticNewsBean.ResultBean.DataBean> list) {
        mList = list;
